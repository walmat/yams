    ...
    <DialogContent className="overflow-clip pb-2">
      <DialogHeader className="flex items-center text-center">
        ...
        <DialogDescription className=" text-foreground">
          An ERC-20 automation toolkit
        </DialogDescription>

        <span className="text-xs text-neutral-700">{updateText}</span>
        <DialogDescription className="flex flex-row"></DialogDescription>
      </DialogHeader>

      <DialogFooter className="flex flex-row items-center border-t pt-2 text-neutral-400">
        <div className="mr-auto flex flex-row gap-2">
          <HomeIcon
            className="h-5 w-5 cursor-pointer text-neutral-600 transition hover:text-black dark:hover:text-white"
        ...
        <DialogPrimitive.Close
          type="submit"
          className={buttonVariants({ variant: "default", className: "h-7" })}
        >
          Close
        </DialogPrimitive.Close>
      </DialogFooter>
